...
//        task22();
    ...
    public static void task16() {
        ...
        students.stream()
                ...
                .forEach(student -> System.out.printf("%s, %d", student.getSurname(), student.getAge()));
    }
    ...
    public static void task19() {
        ...
        examinations.stream()
                ...
                .map(examination -> students.stream()
                        .filter(s -> s.getId() == examination.getStudentId())
                        .findFirst()
                        .orElse(null)).filter(Objects::nonNull)
                .filter(s -> s.getFaculty().equals(RANDOM_GROUP))
                .forEach(System.out::println);
    }
